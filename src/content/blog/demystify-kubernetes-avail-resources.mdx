...
![Kubeadm cluster — kubectl proxy configz output for control plane and worker nodes](/img/blogs/k8s-avail-res-kubeadm-example.png)

And the kubmin dashboard confirms the cluster is running with kubeadm v1.35 on AWS:

![Kubeadm cluster on kubmin dashboard](/img/blogs/k8s-avail-res-kubeadm-example-kubmin.png)
...
![K3s cluster — kubectl proxy configz output for control plane and worker nodes](/img/blogs/k8s-avail-res-k3s-example.png)

The kubmin dashboard for the K3s cluster:

![K3s cluster on kubmin dashboard](/img/blogs/k8s-avail-res-k3s-example-kubmin.png)
