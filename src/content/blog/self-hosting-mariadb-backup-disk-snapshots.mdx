...
```
                ...
                ┌───────────────────────┴───────────────────────┐
                │                                               │
        BACKUP PATH A                                  BACKUP PATH B
        (primary defense)                              (failsafe)
                │                                               │
                ▼                                               ▼
   ┌─────────────────────────┐                    ┌────────────────────────┐
   │  Azure Backup Vault     │                    │  Backup Disk (LUN 11)  │
   │  hourly disk snapshots  │                    │  /mariadbbackup        │
   │  7-day retention        │                    │  mariadb-backup        │
   │  zero prod impact       │                    │  --backup + --prepare  │
   │  (binlogs included)     │                    │  → bootable datadir    │
   └────────────┬────────────┘                    └────────────┬───────────┘
                │                                              │
                │                                              ▼
                │                                    ┌─────────────────────┐
