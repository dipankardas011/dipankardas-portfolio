...
cover: "https://github.com/dipankardas011/wae/blob/main/cover.webp?raw=true"
---
...
<Callout type="important">
  WASI's security model is **deny by default** — a module has zero access to the filesystem, network, or environment variables unless the host runtime explicitly grants it. This is fundamentally different from native executables and is one of WASI's biggest strengths.
</Callout>
...
<figure>
  <img src="/img/blogs/initial_wasi.svg" alt="Individual component repos" />
  <figcaption>We first have repos for individual components like this</figcaption>
</figure>

<figure>
  <img src="/img/blogs/composition_wasi.svg" alt="WASI composition" />
  <figcaption>Then here comes the interesting part of composition</figcaption>
</figure>

<figure>
  <img src="/img/blogs/final_wasi.svg" alt="Complete WASI picture" />
  <figcaption>And here comes the complete picture</figcaption>
</figure>
...
<Callout type="caution">
  Async support in WASI modules is still immature as of v0.2.0. If your use case requires async I/O (e.g., concurrent HTTP requests), you'll need to work around this with synchronous patterns or wait for the async proposal to stabilise in a future preview.
</Callout>
...
<figure>
  <img src="/img/blogs/wae-pass.webp" alt="Random password generation demo" />
  <figcaption>Random password generation</figcaption>
</figure>

<figure>
  <img src="/img/blogs/wae-release.webp" alt="GitHub API repo details" />
  <figcaption>Talking with the GitHub API to get repo details</figcaption>
</figure>

<figure>
  <img src="/img/blogs/wae-openai.webp" alt="OpenAI text to image" />
  <figcaption>Talking with the OpenAI API to generate an image from text</figcaption>
</figure>

<figure>
  <img src="/img/blogs/wae-green.webp" alt="CO2 emission data from Wasmtime" />
  <figcaption>Talking with the Wasmtime API to get CO₂ emission for a given region</figcaption>
</figure>
