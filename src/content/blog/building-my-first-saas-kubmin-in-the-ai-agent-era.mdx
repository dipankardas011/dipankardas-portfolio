...
You have been shipping faster with AI agents. Faster deploys, faster PRs, faster prototypes. But something quietly changed — the codebase is growing faster than your understanding of what it does. I know because I built [Kubmin](https://ksctl.com/product/kubmin), my first SaaS, long enough for the architecture decisions to start arguing back.
...
And here is the bonus tip: I have already made an [Agent SKILL.md](https://dipankar-das.com/skills) to help you go from zero to a production-ready Authzed setup.
...
If I only understand the feature superficially — the direction seems right but the path is unknown — I do not ask an agent to build it. That is how you get architecture by hallucination.
