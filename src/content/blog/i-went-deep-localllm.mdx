...
<figure>
  <img src="/img/blogs/experimenting-3-way.png" alt="Three-way tmux comparison: local Qwen distill on the left, Qwen 3.6 Plus in the middle, Claude Opus 4.6 on the right, all working on the same refactor task" />
